...
class MYPDF extends TCPDF {
    ...
    public function ColoredTable($header,$data) {
        ...
        foreach($data as $row) {
            ...
            $this->Cell($w[2], 6, $row["Jenis_Kelamin"], 'LR', 0, 'L', $fill);
            $this->Cell($w[3], 6, $row["Agama"], 'LR', 0, 'L', $fill);
...
$pdf->SetHeaderData('', 0, 'LAPORAN DATA SISWA', '');
...
// column titles
$header = array('ID', 'Nama', 'Jenis Kelamin', 'Agama');
